...
<table ><tr align="right"><td> <form action="status.jsp" method="post">
  ...
  <tr><td>
   ...
   Refrence:<br>
  <input type="text" name="id"  class="form-control" value="<%=s.getReference() %>"  disabled target="home" ><br>
  Staus:<br>
   <input type="text" name="d"  class="form-control" value="<%=s.getS() %>" disabled target="home" ><br>
